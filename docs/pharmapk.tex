...
\caption{분포용적의 개념(그림 입체적으로 그리기-육면체와 풍선 모양으로)\index{분포용적}}\label{fig:vd-concept}
\end{figure}
...
비선형약동학을 이해하기 위해서는 우선 그림 \ref{fig:nonlin-slope}과 식 \eqref{eq:nonlin}에 나타난 바와 같이 혈장 약물농도와 대사속도(제거속도)의 관계, CL과의 관계를 살펴보아야 한다.
...
{\centering \includegraphics[width=1\linewidth]{media-01/image16} 
...
\ExtensionTok{Date}\NormalTok{ and Time: 2021{-}06{-}12 02:02:27 Asia/Seoul}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}media{-}04/image1.png\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}media{-}04/image2.png\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}media{-}04/image3.jpg\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}media{-}04/image4.png\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Error in knitr::include_graphics("media-04/image4.png"): Cannot find the file(s): "media-04/image4.png"
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}media{-}01/image1.png\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}media{-}04/image6.png\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
