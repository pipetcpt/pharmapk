...
\ExtensionTok{Date}\NormalTok{ and Time: 2021{-}06{-}14 12:44:45 Asia/Seoul}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}media{-}04/image4.jpg\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}media{-}01/image5.jpg\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
