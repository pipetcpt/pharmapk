...
\ExtensionTok{Date}\NormalTok{ and Time: 2021{-}06{-}17 00:51:41 Asia/Seoul}
...
경구 투여 일구획 분석, 지연시간이 있는 모형이다. k\textsubscript{a}, V, k에 T\textsubscript{lag}가 추가되어 농도를 나타낼 수 있다.
...
아래의 코드는 경구 투여 2구획 분석, 지연시간이 없는 모형이다.
...
\begin{center}\includegraphics[width=1\linewidth]{pharmapk_files/figure-latex/unnamed-chunk-38-1} \end{center}
