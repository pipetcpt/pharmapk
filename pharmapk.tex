...
\ExtensionTok{Date}\NormalTok{ and Time: 2022{-}05{-}13 16:39:04 Asia/Seoul}
...
지난 5년간(2016\textasciitilde2020년 기준) FDA에 허가된 총 228개의 의약품 중 항체의약품는 총 59개로 이는 전체의약품의 약 26\%에 해당하는대 이는 10년 전(2006\textasciitilde2010년 기준, 18\%)에 비해 50\% 가까이 증가한 수치이며 계속해서 증가하는 추세이다.(\protect\hyperlink{ref-fdaapproval}{Mullard 2022}) \index{항체의약품}
...
\hypertarget{uxd56duxccb4-uxbc0f-uxd56duxccb4uxc758uxc57duxd488uxc774uxb780}{%
\section{항체 및 항체의약품이란?}\label{uxd56duxccb4-uxbc0f-uxd56duxccb4uxc758uxc57duxd488uxc774uxb780}}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{media-07/antibody_act} 

}

\caption{항체의 작용}\label{fig:act-antibody}
\end{figure}



항체(Antibody, Ab)는 면역글로불린(Immunoglobulin, Ig)로도 지칭되며 특정 세포나 단백질과 같은 항원(Antigen)을 특이적으로 인지하여 면역반응을 유발한다. 대부분 당단백질로 구성되어 있으며 그림 \ref{fig:act-antibody}과 같이 주로 체액성 면역반응에서 B 세포의 활성화를 통해 생산되어 항원을 중화(neutralization)하거나 제거하는 역할을 한다. \index{항체} \index{항원}
...
\caption{5가지 항체 아형의 구조 (\protect\hyperlink{ref-2012197}{Strohl and Strohl 2012})}\label{fig:antibody-isotype}
\end{figure}



\hypertarget{uxd56duxccb4uxc758uxc57duxd488uxc758-uxad6cuxc870-uxbc0f-uxc791uxc6a9}{%
...
\caption{항체의약품의 표적과의 결합의 specificity}\label{fig:paratope}
\end{figure}
...
그러나 이러한 다클론항체는 다양한 항체가 혼합되어 있어 일정한 품질로 생산하기가 매우 어렵고 생체 내에서 교차반응(Cross-reactivity)이 나타날 가능성이 크다. (\protect\hyperlink{ref-monoandpoly}{Lipman et al. 2005}) \index{교차반응}
따라서 현재의 항체의약품은 hybridoma 기술을 이용하여 단일 B cell 에서만 생성된 단일클론항체(monoclonal antibody)를 주로 이용한다. (\protect\hyperlink{ref-kohler1975continuous}{Köhler and Milstein 1975}) \index{단일클론항체}
...
\caption{화학적, 분자적 및 기능적 특성에 따라 구분한 항체의 구조}\label{fig:structure}
\end{figure}



\hypertarget{uxd56duxccb4-uxc758uxc57duxd488uxacfc-uxc800uxbd84uxc790uxc758uxc57duxd488uxc758-uxbe44uxad50}{%
...
\hypertarget{uxd56duxccb4uxc758uxc57duxd488uxc758-adme}{%
\section{항체의약품의 ADME}\label{uxd56duxccb4uxc758uxc57duxd488uxc758-adme}}

\hypertarget{uxd761uxc218}{%
...
\caption{항체 의약품의 피하 및 근육 투여 시의 생체이용률 감소 메커니즘 (\protect\hyperlink{ref-zhou2015adme}{Zhou and Theil 2015})}\label{fig:bioavailability}
\end{figure}



일반적으로 항체의약품의 피하 투여 시의 생체이용률은 20\textasciitilde95\% 정도로 약물 마다 매우 다양하며 약물의 구조 및 림프관에서의 작용에 따라서 달라진다. (\protect\hyperlink{ref-zhao2013antibody}{Zhao et al. 2013}) \index{생체이용률}
이러한 생체이용률의 감소에 대해 그림 \ref{fig:bioavailability}과 같은 메커니즘이 제시되고 있으나 이를 정량적으로 예측하기 위한 구체적인 메커니즘은 아직 밝혀져 있지 않으며 비임상시험을 통해서 인간의 생체이용률을 예측하는 방법 역시 저분자의약품에 비해서 아직 잘 구축되어 있지 않다. 피하 및 근육 투여 시의 흡수 속도는 느린 편으로 대부분의 경우 1\textasciitilde8일 정도에 최고 농도에 도달한다.(\protect\hyperlink{ref-zhao2013antibody}{Zhao et al. 2013}) \index{항체의약품} \index{생체이용률}
...
\caption{항체의약품의 혈관에서 조직으로의 이동 (\protect\hyperlink{ref-ryman2017pharmacokinetics}{Ryman and Meibohm 2017})}\label{fig:distribution}
\end{figure}
...
따라서 항체의약품의 조직-혈장에 대한 분배계수(tissue-to-plasma partition coefficient, Kp)는 대체로 0.1\textasciitilde0.5 정도로 낮은 값을 가지며 뇌와 같이 혈관벽의 밀착연접(tight junction)이 더 발달된 경우 0.01 이하로 더 낮게 나타난다. (\protect\hyperlink{ref-ryman2017pharmacokinetics}{Ryman and Meibohm 2017}) 단, 항체의약품의 분포는 타겟수용체와의 결합이 영향을 미칠 수 있기 때문에 타겟수용체가 분포된 조직의 경우 분포 정도에 따라서 더 큰 값이 나타날 수도 있다. 예를 들어 일반 조직보다 타겟수용체가 과발현된 암 조직의 경우 분포 용적이 더 커질 수 있다. \index{분배계수} \index{항체의약품}

\hypertarget{uxc81cuxac70}{%
...
세포내에서의 제거는 그림 \ref{fig:Elimination}과 같이 세포로의 섭취(uptake)의 형태에 따라서 세가지 형태로 구분할 수 있는대 1) 수용체와의 결합 없이 액상내포작용(fluid-phase endocytosis)인 음세포작용(pinocytosis)를 통해서 제거되는 경우와 2) 수용체와의 결합으로 인한 내포작용(endocytosis)을 통해서 제거되는 경우와 3) 면역작용으로 생성된 항-약물항체와의 결합으로 인해 제거되는 경우이다. \index{음세포작용} \index{내포작용}

\begin{verbatim}
## Error in knitr::include_graphics("media-07/needchange!!!.png"): Cannot find the file(s): "media-07/needchange!!!.png"
\end{verbatim}



\hypertarget{uxc74cuxc138uxd3ecuxc791uxc6a9pinocytosisuxc5d0-uxc758uxd55c-uxc81cuxac70}{%
...
인체의 혈관벽은 표면적이 매우 넓기 때문에(1000m\textsuperscript{2}) 해당 기전으로 항체의약품이 빠르게 제거될 수 있으나, IgG와 같이 Fc domain을 가진 경우 음세포작용으로 인한 섭취이후에 리소좀에 의한 분해가 일어나지 않도록 하는 보호기전(\protect\hyperlink{FcRn}{FcRn recycling})을 가지기 때문에 해당 작용으로 인한 제거를 많은 부분 회피할 수 있다. \index{항체의약품}
...
\hypertarget{uxc218uxc6a9uxccb4uxc640uxc758-uxacb0uxd569uxc744-uxd1b5uxd55c-uxc81cuxac70}{%
...
\hypertarget{target-mediated-clearance-tmdd-target-mediated-drug-disposition}{%
...
TMDD로 인해 항체의약품이 제거되는 것은 타겟 수용체의 발현 정도, 타겟 수용체와의 결합친화력, 투여 용량, 타겟-항원 결합체의 제거 속도 등에 영향 받을 수 있어 선형약동학을 보이는 일반적인 구획분석과는 다른 특징을 보이기 때문에 이것을 표현하기 위해 항체의약품의 작용메커니즘을 반영한 모델(TMDD model)을 사용하고 있다. 이 모델에 대한 자세한 부분은 아래에 제시된 \protect\hyperlink{tmdd_model}{TMDD 약동학 모델 분석} 부분을 참고하길 바란다.

\hypertarget{fcux3b3-receptor-mediated-clearance}{%
...
ADA가 발현된 경우와 TMDD가 나타난 경우의 약동학 곡선이 비슷한 양상을 보이는 경향이 있기 때문에 이를 주의하서 판단해야 하며 이에 대한 약동학 곡선 양상에 대한 비교는 아래 \protect\hyperlink{TMDD_ADA}{TMDD와 ADA 비교} 부분을 참고한다.

\hypertarget{tmdd_model}{%
\section[TMDD 모델 분석]{\texorpdfstring{TMDD 모델 분석\footnote{약동학 데이터를 분석하는 업무를 하지 않는 독자들은 이 장을 읽지 않고 넘어가도 좋습니다.}}{TMDD 모델 분석}}\label{tmdd_model}}
...
\caption{다양한 TMDD 모델}\label{fig:TMDDmodel}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{media-07/TMDDbasic} 
...
따라서 혈장에 존재하는 타겟수용체에 대한 1구획 TMDD의 모델의 경우 위의 식을 이용하여 그림 \ref{fig:TMDDcurve0}과 같이 용량별로 시간-농도 곡선을 그릴 수 있다.

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{media-07/DOSE} 

}

\caption{TMDD 모델의 농도 곡선}\label{fig:TMDDcurve0}
\end{figure}



용량에 따라서 선형성이 더 크게 나타날 수 있지만(저용량 혹은 고용량의 경우) 전형적인 TMDD 모델의 형태가 나타나는 경우 시간-농도에 대한 semi-log 곡선은 위와 같이 곡선의 양상에 따라 4가지의 Phase로 구분할 수 있다. 해당 phase에서는 우세한 반응이 서로 다르게 나타나며 이를 이해하면 TMDD 모델의 시간-농도 곡선의 특징을 이해할 수 있다.

\hypertarget{phase-a-0-t-t1}{%
...
높은 용량의 항체가 투여 된 경우 그림 \ref{fig:TMDDcurveA}과 같이 표적 수용체와의 결합 및 포화가 빠르게 일어나서 구간의 경사는 급해지나 A구간의 길이(T\textsubscript{1})는 짧아진다. 따라서 A구간 동안 감소된 항체의약품의 농도는 투여 용량에 상관없이 비슷한 정도로 감소하게 되며 대부분의 경우 대사로 인한 제거는 결합에 의한 제거보다 매우 느리기 때문에 결합으로 인한 제거만 나타났다고 가정하였을 때 이때 감소된 항체의약품의 양은 타겟수용체의 양(\(R_{0}\))이라고 대략적으로 예측할 수 있다(\(R_{0} ≈ L_{0} - L(T_{1})\)).

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{media-07/DOSEA} 

}

\caption{투여용량에 따른 A구간 곡선의 변화}\label{fig:TMDDcurveA}
\end{figure}



체내에 존재하는 표적수용체의 양(R\textsubscript{0})이 많아지는 경우 결합은 빨라지나 포화되는 대에 시간이 더 걸리게 되기 때문에 이러한 경우에는 그림 \ref{fig:R0}과 같이 A구간의 경사는 급해지고 길이(T\textsubscript{1})도 길어져서 이 구간동안 항체의약품의 양은 더 크게 감소한다.
...
\caption{R\textsubscript{0}의 변화에 따른 A구간 주위의 농도 곡선의 변화}\label{fig:R0}
\end{figure}



\hypertarget{phase-b-t1-t-t2}{%
...
로 간단히 정리될 수 있다. 식 \eqref{eq:eq7-10}과 식 \eqref{eq:eq7-11}를 통해 도출된 식 \eqref{eq:eq7-12}를 보았을 때 표적수용체가 포화된 B 구간에는 항체의 시간에 따른 변화량(dL/dt)이 대사에 의한 제거속도 \(k_{el}\)와 항체 양에 비례하는 선형 형태임을 확인할 수 있으며 이때 기울기는 대략 \(k_{el}\)정도이다. IgG의 경우 FcRn에 의한 recycling으로 인해 \(k_{el}\)가 대부분 작은 값을 보이기 때문에 다른 구간에 비해서 비교적 평평한 형태를 보이며 \(k_{el}\)값이 증가함에 따라서 이 구간의 기울기가 급해진다.
...
C구간은 항체의약품의 K\textsubscript{d}값에 영향을 받기 때문에 투여용량에 상관없이 C구간에서의 항체의약품의 농도 범위는 비슷하다. 단, 용량이 증가함에 따라 농도가 \(10K_{d}\)에 도달하는 시간이 오래 걸리기 때문에 그림 \ref{fig:TMDDcurveC}과 같이 구간 C의 시작점인 T\textsubscript{2}가 커진다. 따라서 용량이 증가할 수록 오른쪽으로 그래프가 이동한 듯한 모습을 보인다.
...
이때 해당 구간에서 항체 농도의 기울기가 대략 k\textsubscript{ec}인 이유는 항체의 농도가 매우 낮아진 상황에서는 대부분 타겟 수용체와 결합된 형태로 존재하게 되는데 1) k\textsubscript{ec} \textgreater{} k\textsubscript{el} 인 경우, 결합된 형태가 제거됨에 따라 항체가 제거되는 속도보다 결합하는 속도가 더 커져서 k\textsubscript{ec}에 의해 항체의 농도 변화가 결정된다. 2) k\textsubscript{ec} \textless{} k\textsubscript{el}인 경우, k\textsubscript{el}에 의해 항체가 빠르게 제거되어도 결합된 형태에서 해리되어 항체 농도가 유지 되기 때문에 결국 항체 농도 변화는 k\textsubscript{ec}에 의한 결합체의 농도 변화를 따르게 된다.
...
\hypertarget{m-m-modelmichaelis-menten-modeluxc758-uxc0acuxc6a9}{%
...
\hypertarget{TMDD_ADA}{%
\section{TMDD와 ADA로 인한 제거의 비교}\label{TMDD_ADA}}

동물 종에서의 데이터를 분석할 때 TMDD와 ADA에 의한 제거의 구분이 어려울 때가 있기 때문에 이 부분을 유의해서 해석해야 한다. 두가지의 경우 모두 Semi-log 곡선에서 어느 시점에서 기울기가 급격히 커지는 형태를 보인다는 점에서 유사하기 때문이다. 그러나 위 \protect\hypertarget{ADA}{}{Immunogenicity-mediated clearance} 부분에서 설명한 대로 TMDD와 ADA에 의한 제거는 기본적인 발생 메커니즘이 다르다. TMDD는 타겟수용체와의 결합에 의해서 나타나는 반면 ADA에 의한 제거는 항체의약품에 대한 면역반응으로 생성된 ADA와의 결합으로 인해 나타난다. 따라서 ADA의 검사 결과가 있는 경우 가장 정확하지만 ADA 검사 결과가 없는 경우라도 약동학 결과를 자세히 살펴보면 두 모델의 차이점을 확인하고 구분할 수 있다. TMDD로 인한 경우 그 기울기의 변화 시점이 항체의약품의 농도가 \(K_d\)값에 가까워지는 시점(C구간의 시작)인 대에 반해 ADA에 의한 제거의 경우 항체의약품의 농도와 \(K_d\)값에 상관 없이 면역반응에 필요한 일정 시간이 소요된 후에 나타난다. 따라서 아래 그림 \ref{fig:ADAmodel}과 같이 기울기가 급격히 떨어지는 부근을 관찰하여 시간에 상관없이 비슷한 약물 농도에서 급격히 떨어지는 현상이 나타날 경우 TMDD에 의한 것으로, 약물 농도와 상관없이 비슷한 시간에 급격히 떨어지는 현상이 나타나는 경우 ADA로 인한 제거로 인한 것으로 예측하여 구분할 수 있다.
...
\hypertarget{allometric-scaling}{%
...
\hypertarget{uxb9fauxc74cuxb9d0-5}{%
...
## 
## $`Elapsed Time`
## Time difference of 0.02643 secs
## 
## [1] "## ID = 2 ##"
## $Est
##           k      ka        V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.00549 secs
## 
## [1] "## ID = 3 ##"
## $Est
##           k     ka         V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.006138 secs
## 
## [1] "## ID = 4 ##"
## $Est
##            k      ka         V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.005232 secs
## 
## [1] "## ID = 5 ##"
## $Est
##            k      ka        V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.005782 secs
## 
## [1] "## ID = 6 ##"
## $Est
##            k      ka         V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.005923 secs
## 
## [1] "## ID = 7 ##"
## $Est
##            k       ka        V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.006453 secs
## 
## [1] "## ID = 8 ##"
## $Est
##            k      ka         V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.005562 secs
## 
## [1] "## ID = 9 ##"
## $Est
##             k     ka         V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.01041 secs
## 
## [1] "## ID = 10 ##"
## $Est
##            k      ka         V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.007668 secs
## 
## [1] "## ID = 11 ##"
## $Est
##            k     ka         V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.007438 secs
## 
## [1] "## ID = 12 ##"
## $Est
##            k       ka         V AddErrVar AddErrSD
...
## 
## $`Elapsed Time`
## Time difference of 0.006061 secs
\end{verbatim}
...
\leavevmode\vadjust pre{\hypertarget{ref-kohler1975continuous}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-monoandpoly}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-fdaapproval}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ryman2017pharmacokinetics}{}}%
Ryman, Josiah T., and Bernd Meibohm. 2017. {``Pharmacokinetics of Monoclonal Antibodies.''} \emph{{CPT}: Pharmacometrics {\&} Systems Pharmacology} 6 (9): 576--88. \url{https://doi.org/10.1002/psp4.12224}.
...
\leavevmode\vadjust pre{\hypertarget{ref-2012197}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-zhao2013antibody}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-zhou2015adme}{}}%
